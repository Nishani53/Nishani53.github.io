...
<!-- Main content with forest header image -->
<div class="header" style="background-image: url('back.jpg'); background-size: cover; background-position: center; height: 400px; position: relative;">
  <div class="header-overlay"></div>
  <h1 class="header-title">Welcome! I’m <strong>Naresh Khanal</strong></h1>
</div>
